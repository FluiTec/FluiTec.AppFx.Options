...
namespace FluiTec.AppFx.Options.Managers
{
    ...
    public class ConfigurationManager
    {
        ...
        ///   ServiceCollection.
        /// </remarks>
        public virtual TSettings ExtractSettings<TSettings>(string configurationKey, bool required = false) where TSettings : class, new()
        {
        ...
        public virtual TSettings Configure<TSettings>(IServiceCollection services, bool required = false) where TSettings : class, new()
        {
        ...
        /// <exception cref="System.ArgumentNullException">services or  configurationKey</exception>
        /// <exception cref="System.ArgumentException">Must not be empty - configurationKey</exception>
        public virtual TSettings Configure<TSettings>(IServiceCollection services, string configurationKey, bool required = false)
